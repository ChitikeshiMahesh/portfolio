      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 px-3 sm:px-4">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center pt-16 sm:pt-18 md:pt-20">
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className={`relative mx-auto w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 p-1 shadow-xl transition-all duration-1000 hover:shadow-2xl hover:shadow-indigo-500/25 hover:scale-110 group cursor-default will-change-transform ${
            ...
            <div className="space-y-2 sm:space-y-3 md:space-y-4 px-2 will-change-transform">
            ...
            <div className={`space-y-1 sm:space-y-2 px-3 transition-all duration-1000 delay-600 will-change-transform ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
            ...
            <div className={`flex flex-col space-y-3 sm:space-y-4 justify-center items-center px-3 sm:px-4 transition-all duration-1000 delay-800 will-change-transform ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <button
              ...
              <div className={`flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto max-w-sm sm:max-w-none transition-all duration-1000 delay-1000 will-change-transform ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
                <button 
                  onClick={() => setIsResumeOpen(true)}
                  className="group bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 px-4 sm:px-6 py-3 sm:py-4 rounded-full font-semibold border-2 border-indigo-600 dark:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:border-indigo-700 dark:hover:border-indigo-300 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-indigo-500/20 transform hover:-translate-y-1 hover:scale-105 flex items-center space-x-2 justify-center touch-manipulation text-sm sm:text-base relative overflow-hidden will-change-transform"
                >
            ...
            <div className={`flex justify-center space-x-4 sm:space-x-6 pt-4 sm:pt-6 md:pt-8 transition-all duration-1000 delay-1200 will-change-transform ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <a 
                href="https://github.com/Mahesh-ch06" 
                className="group text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all duration-300 p-2 touch-manipulation hover:scale-110 hover:-translate-y-1 relative will-change-transform"
        ...
        <div className={`absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 hidden md:block transition-all duration-1000 delay-1400 will-change-transform ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
        ...
        <div className="absolute top-20 left-10 w-2 h-2 bg-indigo-300 dark:bg-indigo-600 rounded-full opacity-60 animate-pulse hidden lg:block will-change-transform"></div>
        <div className="absolute top-40 right-20 w-3 h-3 bg-purple-300 dark:bg-purple-600 rounded-full opacity-40 animate-pulse hidden lg:block will-change-transform" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-40 left-20 w-1.5 h-1.5 bg-blue-300 dark:bg-blue-600 rounded-full opacity-50 animate-pulse hidden lg:block will-change-transform" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 right-10 w-2.5 h-2.5 bg-indigo-200 dark:bg-indigo-700 rounded-full opacity-30 animate-pulse hidden lg:block will-change-transform" style={{ animationDelay: '0.5s' }}></div>
      </section>
